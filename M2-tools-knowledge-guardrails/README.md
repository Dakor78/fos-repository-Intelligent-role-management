...
|---|---|---|---|---|
| КИМ-2.0 | 🩺 Входная диагностика | 📖 понимание · КРМ базовый | Диагностика готовности к модулю: цикл агента и уровни сообщений, границы БЯМ, контракты функций, клиент-сервер, поиск по тексту. 12 заданий, **не влияет на итоговую оценку** | [kim-00-diagnostic.md](kim-00-diagnostic.md) |
